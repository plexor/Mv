...
LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid").WalkSpeed = 100
...
if Value == 750 then
debug.setconstant(v, Number, 99999)
...
LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid").JumpPower = 100
LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid").WalkSpeed = 100
